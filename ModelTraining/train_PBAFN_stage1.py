...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    for i, data in enumerate(train_loader):
        ...
        # print("person_clothes_edge.size{}".format(person_clothes_edge.size()))
        ...
        for num in range(5):
            # print("person_clothes.size{}".format(person_clothes.size()))
            ...
            # print([x_all[num].size(), cur_person_clothes.size()])
